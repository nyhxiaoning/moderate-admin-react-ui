  ...
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="code" v-if="captchaEnabled">
        ...
        <!-- 隐藏当前的code 对应 captchaId 双向绑定 -->
         <text v-model="loginForm.captchaId"  > </text>
...
// 引入接口用户信息查询：import { getUserProfile } from '@/api/system/user';
			...
			this.$refs.loginForm.validate((valid) => {
				if (valid) {
					...
					this.$store
						...
						.then((res) => {
							console.log('res-写死的Admin-Token登陆成功',res);
							// 默认页面进入/,其实就是index路由，但是这个页面：getInfo和getRouters接口没有调用
							// TODO:为什么没有调用？
