  ...
  <div class="login">
    <el-form ref="loginRef" :model="loginForm.model" :rules="loginForm.rules" class="login-form">
      ...
      <el-form-item prop="code" v-if="authCodeInfo.captchaEnabled">
        <el-input v-model.trim="loginForm.model.code" maxlength="4" size="large" auto-complete="off" placeholder="验证码"
      ...
      <el-form-item prop="captchaId">
        <!-- <div  v-model="loginForm.model.captchaId" >验证码</div> -->
      </el-form-item>
