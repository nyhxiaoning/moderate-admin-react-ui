...
### swagger模块
比如：启动后：http://127.0.0.1:8080/swagger-ui
http://127.0.0.1:8080/swagger-ui

## 项目第三阶段：react所有的接口换成当前vue的接口的可能性和修改成本？
借助ai能力：毕竟vue项目已经调通了这个项目。


### 完成react的改造后，总结一下
我们快速学习后，最后，整理一下数据库相关设计。

### 完成react的数据库对接后，整理一下大量的模块后台系统如何快速搭建。
